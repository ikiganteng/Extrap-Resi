...
$j = 0;
    while(true){
        $randomAWB = 'EG2'.rand(00000000,99999999).'KR';
        $check = kr($randomAWB);
        $json_check = json_decode($check,true);
            if ($json_check['rajaongkir']['status']['code'] == 200) {
                        ...
                        file_put_contents('kr.txt',"$awb : $status : $date : $origin : $destination ".PHP_EOL,FILE_APPEND);
                        $i++;
...
function kr($awb){
    $url = 'https://www.cekpengiriman.com/wp-content/themes/resiongkir/data/awb/koreapost.php';
	$headers = array();
    ...
    $headers[] = 'Cookie: _ga=GA1.2.1254192368.1617760069; _gid=GA1.2.1611132824.1617760069; __gads=ID=591db80335f6032a-22dd111708c700f7:T=1617760134:RT=1617760134:S=ALNI_MZKqzOpdWB_EcI9YYGvAOjA6bSyow; __Host-cekpengiriman_session=eft23o017kcgpuu9efjm0oh2be; _uuid_session=kn7ptzfk0c0o2znyia7a';
    $headers[] = 'Accept: */*';
	$headers[] = 'Content-Type: application/x-www-form-urlencoded; charset=UTF-8';
	$body = 'nomor='.$awb.'&kurir=koreapost&type=awb&uuid=8e6450b862326d7312f81afecd9d17dd';
